...
import 'package:todo_list/src/common/convert_time.dart';
import 'package:todo_list/src/global_bloc.dart';
import 'package:todo_list/src/models/errors.dart';
import 'package:todo_list/src/models/medicine.dart';
import 'package:todo_list/src/models/medicine_type.dart';
import 'package:todo_list/src/ui/homepage/homepage.dart';
import 'package:todo_list/src/ui/new_entry/new_entry_bloc.dart';
import 'package:todo_list/src/ui/success_screen/success_screen.dart';
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'Medicine Remember: ${medicine.medicineName}',
